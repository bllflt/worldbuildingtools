...
class CharacterRead(CharacterBase):
    ...
    roleplaying_attributes: list[Any]= Field(exclude=True)
    image_attributes: list[Any] = Field(exclude=True)
...
SocialConnection = Annotated[Liaison | Faction, Field(discriminator="type")]
